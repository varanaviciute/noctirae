        ...
        <div className="glass-card rounded-2xl p-8 dream-glow">
          ...
          {!ready && !error && (
            <div className="flex justify-center py-4">
              <span className="w-6 h-6 border-2 border-dream-500/30 border-t-dream-400 rounded-full animate-spin" />
            </div>
          )}

          {error && (
            <p className="text-red-400 text-sm bg-red-500/10 rounded-lg px-3 py-2 mb-4">{error}</p>
          )}
